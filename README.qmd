...
Assertive programming doesn’t have to be ugly. If ultra-fast checks aren’t your top priority, `prettycheck` is for you. This R packge provides a set of functions that produce pretty and informative error messages, primarily using the [`cli`](https://cli.r-lib.org/) package from [r-lib](https://github.com/r-lib).
...
- [`check_numeric()`](https://danielvartan.github.io/prettycheck/reference/check_numeric.html) `test_numeric()` `assert_numeric()`: Check if an argument is a `numeric` object
